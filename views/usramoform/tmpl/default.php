...
PageHelper::initPage( $titleMsg . "Ramo", ""); 
...
?>
	<div class="row-fluid">
		<div class="span12">
			<?php PortletHelper::show("Formulario de Ramos"); ?>
				...
				<form id="form" class="form-horizontal" method="post" >
					...
					<input type='hidden' name='task' value='usRamoSave' />
				</form>
...
<?php 
	...
	PageHelper::addBreadcrumb("Ramo","index.php?option=com_ztadmin&task=usRamoList");
