...
PageHelper::initPage("Listado de Vendedores", ""); 
...
?>
				...
				<div class="row-fluid">
					<div class="span12">
						<?php PortletHelper::show("Listado de Vendedores"); ?>		
									<div class="clearfix">
										<form name='formBusqueda'>
											...
											<input type='hidden' name='task' value='usVendedorList' />
										</form>
										...
										<div aria-hidden="true" aria-labelledby="myModalLabel3" role="dialog" 
												 tabindex="-1" class="modal hide fade" id="modalEliminar" style="display: none;">
														...
														<div class="modal-body">
															<p>Desea eliminar todos los vendedores, recuerde que estos cambios no pueden ser recuperados.</p>
														</div>
								...
								<form id='formTable' >
										...
										<tbody>
											<?php
												if(isset($this->data)){
													foreach($this->data as $item){
														$rutaEditar = "index.php?option=com_ztadmin&task=usVendedorForm&id=".$item->id;
														$linkEditar = "<a class='btn blue' href='{$rutaEditar}'>Editar</a>";
														$rutaEliminar = "index.php?option=com_ztadmin&task=usVendedorDelete&id=" . $item->id;
											...
											?>
												<tr class="odd gradeX">
													...
													<td class="hidden-480"><?php echo $item->apellido;?></td>
													<td class="hidden-480"><?php echo $item->direccion;?></td>
													<td class="hidden-480"><?php echo $item->telefono;?></td>
									...
									<input type='hidden' name='option' value='com_ztadmin' />
									<input type='hidden' id='task' name='task' value='usVendedorList' />
								</form>
...
<?php 
	...
	PageHelper::addBreadcrumb("Vendedores","index.php?option=com_ztadmin&task=usVendedorList");
