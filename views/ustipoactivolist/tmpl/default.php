						...
						<?php PortletHelper::show("Listado de contactos"); ?>
									...
									<div class="clearfix">
										<form name='formBusqueda'>
											...
											<input type='hidden' name='task' value='veContactoList' />
										</form>
								...
								<form id='formTable' >
											...
											<?php
												if(isset($this->data)){
													foreach($this->data as $item){
														$rutaEditar = "index.php?option=com_ztadmin&task=veContactoForm&id=".$item->id;
														$linkEditar = "<a class='btn blue' href='{$rutaEditar}'>Editar</a>";
														$rutaEliminar = "index.php?option=com_ztadmin&task=veContactoDelete&id=" . $item->id;
									...
									<input type='hidden' name='option' value='com_ztadmin' />
									<input type='hidden' id='task' name='task' value='veContactoDelete' />
								</form>
