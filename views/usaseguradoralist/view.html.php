 ...
 * @since		
 */
class ViewUsAseguradoraList extends JView
{
	protected $form;
	protected $params;
	protected $state;
	...
	public function display($tpl = null)
	{
		...
		$model = $this->getModel('Aseguradora');

		$data 		= $model->listarAseguradoras($filtro, $inicio, $registros);
		$cantidad 	= $model->contarAseguradoras($filtro);
