...
PageHelper::initPage("Listado de Aseguradoras", ""); 
...
?>
				...
				<div class="row-fluid">
					<div class="span12">
						<?php PortletHelper::show("Listado de aseguradoras"); ?>		
									<div class="clearfix">
										<form name='formBusqueda'>
											...
											<input type='hidden' name='task' value='usAseguradoraList' />
										</form>
										...
										<div aria-hidden="true" aria-labelledby="myModalLabel3" role="dialog" 
												 tabindex="-1" class="modal hide fade" id="modalEliminar" style="display: none;">
														...
														<div class="modal-body">
															<p>Desea eliminar todos los contactos, recuerde que estos cambios no pueden ser recuperados.</p>
														</div>
								...
								<form id='formTable' >
											...
											<?php
												if(isset($this->data)){
													foreach($this->data as $item){
														$rutaEditar = "index.php?option=com_ztadmin&task=usAseguradoraForm&id=".$item->id;
														$linkEditar = "<a class='btn blue' href='{$rutaEditar}'>Editar</a>";
														$rutaEliminar = "index.php?option=com_ztadmin&task=usAseguradoraDelete&id=" . $item->id;
									...
									<input type='hidden' name='option' value='com_ztadmin' />
									<input type='hidden' id='task' name='task' value='usAseguradoraList' />
								</form>
