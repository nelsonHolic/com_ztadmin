 ...
 * @since		
 */
class ViewVeBandejaNoEnviadosBorrarTodos extends JView
{
	protected $form;
	protected $params;
	protected $state;
	...
	public function display($tpl = null)
	{
		...
		if($model->eliminarMensajesOutboxNoEnviados()){
			$result = JText::_('M_OK') . sprintf( JText::_('VE_BORRAR_TODOS_MENSAJE_OUTBOX_NO_ENVIADOS_OK') ,'');
		}
		else{
