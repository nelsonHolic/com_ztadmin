										...
										<?php
											if(isset($this->data)){
												foreach($this->data as $item){
													$rutaEditar = "index.php?option=com_ztadmin&task=veUsuarioForm&id=" . $item->id;
													$linkEditar = "<a class='btn blue' href='{$rutaEditar}'>Editar</a>";
													$rutaEliminar = "index.php?option=com_ztadmin&task=veUsuarioDelete&id=" . $item->id;
													...
													$rutaBloquear = "index.php?option=com_ztadmin&task=veUsuarioBlock&id=" . $item->id."&block=1";
													$linkBloquear = "<a class='btn blue' href='{$rutaBloquear}'>Bloquear</a>";
													$rutaDesBloquear = "index.php?option=com_ztadmin&task=veUsuarioBlock&id=" .$item->id."&block=0";
