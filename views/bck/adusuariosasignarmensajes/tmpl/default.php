		...
		<div class="span12">
			<?php PortletHelper::show("Asignacion Mensajes a Usuario"); ?>
				...
				<form class="form-horizontal" method="POST" >
									...
									<div class="controls">
										 <select name='cantidad'>
											...
											<?php foreach($this->mensajes as $item){?>
												<option value="<?php echo $item->cantidad ?>" <?php echo ($item->cantidad == $this->mensajesActual ? "selected" : ""); ?>>
					...
					<input type='hidden' name='task' value='adUsuariosAsignarMensajesSave' />
				</form>
