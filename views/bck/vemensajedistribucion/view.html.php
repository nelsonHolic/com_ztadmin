 ...
 * @since		
 */
class ViewVeMensajeDistribucion extends JView
{
	protected $form;
	protected $params;
	protected $state;
	...
	public function display($tpl = null)
	{
		...
		$data 		= $model->listarMensajesVendedores($filtro, $inicio, $registros);
		$cantidad 	= $model->contarMensajesVendedores($filtro);
