 ...
 * @since		
 */
class ViewVeBandejaProgramados extends JView
{
	protected $form;
	protected $params;
	protected $state;
	...
	public function display($tpl = null)
	{
		...
		$data 		= $model->listarMensajesProgramados($filtro, $inicio, $registros);
		$cantidad 	= $model->contarMensajesProgramados($filtro);
