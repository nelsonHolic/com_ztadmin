...
PageHelper::initPage("Bandeja de eliminados", ""); 
				...
				<div class="row-fluid inbox">
					...
					<div class="span12">
						...
						<form id='formTable' action="index.php" method="post">
												...
												<div aria-hidden="true" aria-labelledby="myModalLabel3" role="dialog" 
												 tabindex="-1" class="modal hide fade" id="modalEliminar" style="display: none;">
														...
														<div class="modal-body">
															<p>Desea eliminar todos los elementos de la bandeja de eliminados, recuerde que estos cambios no pueden ser recuperados.</p>
														</div>
														<div class="modal-footer">
															<button aria-hidden="true" data-dismiss="modal" class="btn">Cancelar</button>
															<a class='btn blue' href='index.php?option=com_ztadmin&task=veBandejaEliminadosBorrarTodos'>Borrar</a>
														</div>
												</div>
							...
							<input type='hidden' name='option' value='com_ztadmin' />
							<input type='hidden' name='task' value='veMensajeEliminarOutboxFisico' />
						</form>
					</div>
				</div>
	</div>
...
<?php 
	...
	PageHelper::addFinalBreadcrumb("Eliminados");
