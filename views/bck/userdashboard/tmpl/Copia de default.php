			...
			<ul>
				...
				<li class="">
					...
					<ul class="sub-menu">
						...
						<li >
							<a href="horizontal_menu1.html">
							<i class="icon-sitemap"></i>
							Horzontal Menu 1							</a>
						</li>
						<li >
							<a href="horizontal_menu2.html">
				...
				<li class="">
					...
					<ul class="sub-menu">
						...
						<li >
							<a href="extra_blank.html">
							Blank Page							</a>
						</li>
						<li >
							<a href="extra_full_width.html">
							Full Width Page							</a>
						</li>
					</ul>
				</li>
					...
					<div class="row-fluid">
						<div class="span6">
							<div class="portlet box purple">
								<div class="portlet-title">
									<h4><i class="icon-calendar"></i>General Stats</h4>
									<div class="actions">
						...
						<div class="span6">
							<div class="portlet box blue">
								<div class="portlet-title">
									<h4><i class="icon-calendar"></i>Server Stats</h4>
									<div class="tools">
