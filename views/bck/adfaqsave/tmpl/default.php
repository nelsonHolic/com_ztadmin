...
PageHelper::initPage("Creacion / Edicion Preguntas Frecuentes", ""); 
...
PageHelper::addBreadcrumb("Preguntas","index.php?option=com_ztadmin&task=adFaqList");
PageHelper::addFinalBreadcrumb("Crear / Editar");
?>
