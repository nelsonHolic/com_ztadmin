 ...
 * @since		
 */
class ViewVeBandejaSalida extends JView
{
	protected $form;
	protected $params;
	protected $state;
	...
	public function display($tpl = null)
	{
		...
		$data 		= $model->listarMensajesBandejaSalida($filtro, $inicio, $registros);
		$cantidad 	= $model->contarMensajesBandejaSalida($filtro);
