...
PageHelper::initPage("Bandeja de salida", ""); 
												...
												<div aria-hidden="true" aria-labelledby="myModalLabel3" role="dialog" 
												 tabindex="-1" class="modal hide fade" id="modalEliminar" style="display: none;">
														...
														<div class="modal-footer">
															...
															<a class='btn blue' href='index.php?option=com_ztadmin&task=veBandejaSalidaBorrarTodos'>Borrar</a>
														</div>
												</div>
...
<?php 
	...
	PageHelper::addFinalBreadcrumb("Salida");
