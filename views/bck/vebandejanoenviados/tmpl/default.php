...
PageHelper::initPage("Bandeja de no enviados", ""); 
					...
					<div class="span12">
						<div class="inbox-header">
							...
							<form name='form' class="form-search pull-right">
								...
								<input type='hidden' name='task' value='veBandejaEnviados' />
							</form>
						</div>
												...
												<div aria-hidden="true" aria-labelledby="myModalLabel3" role="dialog" 
												 tabindex="-1" class="modal hide fade" id="modalEliminar" style="display: none;">
														...
														<div class="modal-body">
															<p>Desea eliminar todos los elementos de la bandeja de enviados, recuerde que estos cambios no pueden ser recuperados.</p>
														</div>
														<div class="modal-footer">
															<button aria-hidden="true" data-dismiss="modal" class="btn">Cancelar</button>
															<a class='btn blue' href='index.php?option=com_ztadmin&task=veBandejaNoEnviadosBorrarTodos'>Borrar</a>
														</div>
												</div>
									...
									<tbody>
										...
										<tr>
											...
											<td class="view-message ">
												<a href="index.php?option=com_ztadmin&task=veMensajeDetalleOutbox&id=<?php echo $item->id;?>" >
													<?php echo $item->acceptedfordeliverytime;?>
												</a>
											</td>
...
<?php 
	...
	PageHelper::addFinalBreadcrumb("No enviados");
