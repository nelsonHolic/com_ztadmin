...
PageHelper::initPage("Bandeja de entrada", ""); 
				...
				<div class="row-fluid inbox">
					...
					<div class="span12">
						...
						<form id='formTable' action="index.php" method="post">
											...
											<th colspan="3">
												...
												<div class="btn-group">
													...
													<ul class="dropdown-menu pull-left">
														<!--<li><a href="#"><i class="icon-pencil"></i> Opcion 1</a></li>
														<li><a href="#"><i class="icon-ban-circle"></i> Opcion 2</a></li>
														<li class="divider"></li>
														-->
														<li>
												...
												<div aria-hidden="true" aria-labelledby="myModalLabel3" role="dialog" 
														...
														<div class="modal-body">
															<p>Desea eliminar todos los elementos de la bandeja de entrada, recuerde que estos cambios no pueden ser recuperados.</p>
														</div>
														<div class="modal-footer">
															<button aria-hidden="true" data-dismiss="modal" class="btn">Cancelar</button>
															<a class='btn blue' href='index.php?option=com_ztadmin&task=veBandejaRecibidosBorrarTodos'>Borrar</a>
														</div>
												</div>
									...
									<tbody>
										...
										<tr >
											<td class="inbox-small-cells">
												<div class="checker2" id="uniform-undefined"><span>
													<input name='mensajes[]' value="<?php echo $item->id; ?>" type="checkbox"  style="opacity: 0;" /></span>
												</div>
											</td>
											<td class="inbox-small-cells"><i class="icon-star"></i></td>
											<td class="view-message  hidden-phone">
												<a href="index.php?option=com_ztadmin&task=veMensajeDetalleInbox&id=<?php echo $item->id;?>" >
							...
							<input type='hidden' name='option' value='com_ztadmin' />
							<input type='hidden' name='task' value='veMensajeEliminarInbox' />
...
<?php 
	...
	PageHelper::addFinalBreadcrumb("Entrada");
	
	//Limpia el breadcrumb
	//echo PageHelper::cleanBreadcrumb();
	
	//Cuenta mensajes en bandejas
	/*$entrada 		= Mensajes::contarMensajesEntrada();
	$salida  		= Mensajes::contarMensajesSalida();
	$programados 	= Mensajes::contarMensajesProgramados();
	*/
	
	//Actualiza Gui
	//Menu::changeMenuText(79, "Entrada ($entrada)" );
	//Menu::changeMenuText(80, "Salida ($salida)" );
	//Menu::changeMenuText(82, "Salida ($programados)" );
?>
...
jQuery(document).ready(function(){ 
	 //alert( jQuery('#79').find( ".title" ).text() );
	 //jQuery('#79').find( ".title" ).text( jQuery('#79').find( ".title" ).text() + " (12) " );
});
</script>
