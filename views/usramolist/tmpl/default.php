...
PageHelper::initPage("Listado de Ramos", ""); 
...
?>
				...
				<div class="row-fluid">
					<div class="span12">
						<?php PortletHelper::show("Listado de Ramos"); ?>		
									<div class="clearfix">
										<form name='formBusqueda'>
											...
											<input type='hidden' name='task' value='usRamoList' />
										</form>
								...
								<form id='formTable' >
											...
											<?php
												if(isset($this->data)){
													foreach($this->data as $item){
														$rutaEditar = "index.php?option=com_ztadmin&task=usRamoForm&id=".$item->id;
														$linkEditar = "<a class='btn blue' href='{$rutaEditar}'>Editar</a>";
														$rutaEliminar = "index.php?option=com_ztadmin&task=usRamoDelete&id=" . $item->id;
									...
									<input type='hidden' name='option' value='com_ztadmin' />
									<input type='hidden' id='task' name='task' value='usRamoList' />
								</form>
...
<?php 
	...
	PageHelper::addBreadcrumb("Ramos","index.php?option=com_ztadmin&task=usRamoList");
