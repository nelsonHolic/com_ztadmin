...
PageHelper::initPage( $titleMsg . "Ciiu", ""); 
...
?>
	<div class="row-fluid">
		<div class="span12">
			<?php PortletHelper::show("Formulario de Ciius"); ?>
				...
				<form id="form" class="form-horizontal" method="post" >
						...
						<div class="row-fluid">
							<div class="span12 ">
								<div class="control-group ">
									...
									<div class="controls">
									   <input name="codigo" type="text" value='<?php echo $codigo;?>' class="m-wrap span12" >
									</div>
								</div>
							</div>
						</div>
					...
					<input type='hidden' name='task' value='usCiiuSave' />
				</form>
