...
PageHelper::initPage( $titleMsg . " tipo de activo", ""); 

$id          = (isset($data->id) ? $data->id : "");
$descripcion = (isset($data->descripcion) ? $data->descripcion : "");
$periocidad  = (isset($data->periocidad) ? $data->periocidad : "");

?>
	<div class="row-fluid">
		<div class="span12">
			<?php PortletHelper::show("Formulario de tipos de activos"); ?>
				...
				<form id="form" class="form-horizontal" method="post" >
					<fieldset>
						...
						<div class="row-fluid">
							<div class="span12 ">
								<div class="control-group">
									<label class="control-label">Periocidad<span class="required">*</span></label>
									<div class="controls">
										
										<label class="radio">
											<input type="radio" name="tipo" value="A" <?php echo ($periocidad == 'A') ? "checked" : "" ;?> />
											Anual
										</label>  
										
										<label class="radio">
											<input type="radio" name="tipo" value="M" <?php echo ($periocidad == 'M') ? "checked" : "" ;?>/>
											Mensual
										</label>  
										
										<label class="radio">
											<input type="radio" name="tipo" value="D" <?php echo ($periocidad == 'D') ? "checked" : "" ;?>/>
											Diaria
										</label>  
					...
					<input type='hidden' name='task' value='usTipoActivoSave' />
				</form>
...
<?php 
	...
	PageHelper::addBreadcrumb("Tipos de activos","index.php?option=com_ztadmin&task=usTipoActivoList");
